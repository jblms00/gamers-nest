...
<head>
    ...
    <title>All Guilds | Gamer's Nest</title>
</head>
        ...
        <div class="main-feed container-fluid">
            <div class="outer-container">
                ...
                <div class="input-container">
                    <button type="button" class="me-3 za-filter-guilds"><i
                            class="bi bi-sort-alpha-down-alt"></i></button>
                    <input type="text" id="searchAllGuilds" class="search-guild-input" placeholder="Search guilds">
                </div>
            </div>
            <div class="guilds-container" id="guildsContainer">
                <!-- Display guild here -->
            </div>
        </div>
    </div>

...
<body class="admin-side admin-users-page">
    <div class="header">
    ...
    <div class="admin-tables">
        <h3 class="table-name">Gamer's Nest Member Records</h3>
        <div class="btn-options">
            <button type="button" class="remove-selected-btn d-none" id="removeSelectedUsersButton">Remove
                Selected</button>
            <input type="text" id="userSearch" placeholder="Search users">
            <button type="button" data-bs-toggle="modal" data-bs-target="#modalRemovedAllData">Remove All</button>
        </div>
        <table class="table text-center table-bordered" id="userTable">
            <!-- Table Content -->
        </table>
    </div>
    ...
    <div class="modal fade" id="editUser" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" id="editUserDialog">
            <!-- Modal Content -->
        </div>
    </div>
    <!-- Modal - Removed Data -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Remove All Users</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p class="mb-0"> Are you sure you want to remove all the users?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="modal-opt-btn" data-bs-dismiss="modal">No</button>
                    <button type="button" class="modal-opt-btn remove-users-btn">Yes</button>
                </div>
            </div>
        </div>
    </div>

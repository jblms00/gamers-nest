...
<body class="admin-side admin-guild-page">
    <div class="header">
    ...
    <div class="admin-tables">
        <h3 class="table-name">Gamer's Nest - Overall Guilds</h3>
        <div class="btn-options">
            <button type="button" class="remove-selected-btn d-none" id="removeSelectedGuildsButton">Remove
                Selected</button>
            <input type="text" id="guildSearch" placeholder="Search guilds">
            <button type="button" data-bs-toggle="modal" data-bs-target="#modalRemovedAllData">Remove All</button>
        </div>
        <table class="table text-center table-bordered" id="guildsTable">
            <!-- Table Content -->
        </table>
    </div>
    ...
    <div class="modal fade" id="editGuild" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" id="editGuildDialog">
            <!-- Modal Content -->
        </div>
    </div>
    <!-- Modal - Removed Data -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Remove All Guilds</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p class="mb-0"> Are you sure you want to remove all the guilds?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="modal-opt-btn" data-bs-dismiss="modal">No</button>
                    <button type="button" class="modal-opt-btn remove-guilds-btn">Yes</button>
                </div>
            </div>
        </div>
    </div>

...
<body class="admin-side admin-vroom-page">
    <div class="header">
    ...
    <div class="admin-tables">
        <h3 class="table-name">Gamer's Nest Voice Rooms</h3>
        <div class="btn-options">
            <button type="button" class="remove-selected-btn d-none" id="removeSelectedRoomsButton">Remove
                Selected</button>
            <input type="text" id="roomSearch" placeholder="Search voice rooms">
            <button type="button" data-bs-toggle="modal" data-bs-target="#modalRemovedAllData">Remove All</button>
        </div>
        <table class="table text-center table-bordered" id="roomsTable">
            <!-- Table Content -->
        </table>
    </div>


    <!-- Modal - Edit Voice Room -->
    <div class="modal fade" id="editRoom" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" id="editRoomDialog">
            <!-- Modal Content -->
        </div>
    </div>
    <!-- Modal - Removed Data -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Remove All Voice Rooms</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p class="mb-0"> Are you sure you want to remove all the voice rooms?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="modal-opt-btn" data-bs-dismiss="modal">No</button>
                    <button type="button" class="modal-opt-btn remove-rooms-btn">Yes</button>
                </div>
            </div>
        </div>
    </div>

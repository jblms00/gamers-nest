...
<body class="admin-side admin-posts-page">
    <div class="header">
    ...
    <div class="admin-tables">
        <h3 class="table-name">Cumulative Gamer's Nest Posts</h3>
        <div class="btn-options">
            <button type="button" class="remove-selected-btn d-none" id="removeSelectedPostsButton">Remove
                Selected</button>
            <input type="text" id="postSearch" placeholder="Search posts">
            <button type="button" data-bs-toggle="modal" data-bs-target="#modalRemovedAllData">Remove All</button>
        </div>
        <table class="table text-center table-bordered" id="postsTable">
            <!-- Table Content -->
        </table>
    </div>
    ...
    <div class="modal fade" id="editPost" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" id="editPostDialog">
            <!-- Modal Content -->
        </div>
    </div>
    <!-- Modal - Removed Data -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="modal-opt-btn remove-posts-btn">Yes</button>
                </div>
            </div>
        </div>
    </div>

...
<head>
    ...
    <!-- Emoji -->
    <link rel="stylesheet" href="src/css/emojionearea.min.css">
    <!-- Bootstrap Icon -->
...
<body class="msg-body user-index convo-page" data-userid="<?php echo $current_user_id; ?>">
    ...
    <div class="msg-container" id="messageContainer">
        ...
        <div class="msg-right-sidebar" id="rightSidebar"></div>
    </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
    <!-- Emoji -->
    <script src="src/js/emojionarea.min.js"></script>
    <!-- Users JS -->
    <script src="src/js/user-messages-script.js"></script>
</body>
